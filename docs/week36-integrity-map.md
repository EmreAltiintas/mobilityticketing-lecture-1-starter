...
6. Steps 3–5 belong in one transaction so that a failure partway through (no seats, gateway decline) leaves no ticket or payment visible to any other reader — not implemented by this migration; flagged for the transactions lecture.
